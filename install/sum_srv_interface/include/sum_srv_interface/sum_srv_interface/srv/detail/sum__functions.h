...
#ifndef SUM_SRV_INTERFACE__SRV__DETAIL__SUM__FUNCTIONS_H_
#define SUM_SRV_INTERFACE__SRV__DETAIL__SUM__FUNCTIONS_H_
...
#include "sum_srv_interface/msg/rosidl_generator_c__visibility_control.h"

#include "sum_srv_interface/srv/detail/sum__struct.h"

/// Initialize srv/Sum message.
/**
...
/// Create srv/Sum message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sum_srv_interface__srv__Sum_Request__init().
...
/// Destroy srv/Sum message.
/**
 * It calls
 * sum_srv_interface__srv__Sum_Request__fini()
...
/// Check for srv/Sum message equality.
/**
...
/// Initialize array of srv/Sum messages.
/**
...
/// Finalize array of srv/Sum messages.
/**
 * It calls
 * sum_srv_interface__srv__Sum_Request__fini()
...
/// Create array of srv/Sum messages.
/**
 * It allocates the memory for the array and calls
 * sum_srv_interface__srv__Sum_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Sum messages.
/**
 * It calls
 * sum_srv_interface__srv__Sum_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Sum message array equality.
/**
...
/// Copy an array of srv/Sum messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sum_srv_interface__srv__Sum_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sum_srv_interface
...
/**
 * It calls
 * sum_srv_interface__srv__Sum_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sum_srv_interface
...
/**
 * It allocates the memory for the array and calls
 * sum_srv_interface__srv__Sum_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sum_srv_interface
...
/**
 * It calls
 * sum_srv_interface__srv__Sum_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SUM_SRV_INTERFACE__SRV__DETAIL__SUM__FUNCTIONS_H_
