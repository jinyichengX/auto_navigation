...
class Metaclass_Sum_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('sum_srv_interface')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Sum(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from sum_srv_interface.srv import _sum
...
class Sum(metaclass=Metaclass_Sum):
    from sum_srv_interface.srv._sum import Sum_Request as Request
    from sum_srv_interface.srv._sum import Sum_Response as Response
