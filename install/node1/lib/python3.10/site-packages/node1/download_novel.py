...
def main():
    download1 = download()
    download1.start_download("http://localhost:8000/core/node1/node1/novel/chapter1.txt",count_text_size)
    download1.start_download("http://localhost:8000/core/node1/node1/novel/chapter2.txt",count_text_size)
    download1.start_download("http://localhost:8000/core/node1/node1/novel/chapter3.txt",count_text_size)