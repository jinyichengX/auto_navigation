...
#include "sum_srv_interface/srv/detail/sum__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sum_srv_interface::srv::Sum_Request;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const sum_srv_interface::srv::Sum_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sum_srv_interface::srv::Sum_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_sum_srv_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<sum_srv_interface::srv::Sum_Request>()
{
  return &sum_srv_interface::srv::typesupport_fastrtps_cpp::_Sum_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = sum_srv_interface::srv::Sum_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sum_srv_interface::srv::Sum_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<sum_srv_interface::srv::Sum_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &sum_srv_interface::srv::typesupport_fastrtps_cpp::_Sum_Response__handle;
}
...
{
  return &sum_srv_interface::srv::typesupport_fastrtps_cpp::_Sum__handle;
}
